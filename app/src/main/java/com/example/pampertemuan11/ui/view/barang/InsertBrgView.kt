...
import com.example.pampertemuan11.ui.viewmodel.BarUIState
import com.example.pampertemuan11.ui.viewmodel.BarangEvent
import com.example.pampertemuan11.ui.viewmodel.FormErrorStateBar
import com.example.pampertemuan11.ui.viewmodel.HomeSplViewModel
import com.example.pampertemuan11.ui.viewmodel.InsertBrgViewModel
import com.example.pampertemuan11.ui.viewmodel.PenyediaViewModel
import com.example.pampertemuan11.ui.viewmodel.SuplierEvent
...
fun FormBarang(
    ...
    val splUi by HomeSplViewModel.homeSplUiState.collectAsState()
    Column(
        modifier = modifier.fillMaxWidth()
    ) {
        OutlinedTextField(
        ...
        DropDownSupllier(
            ...
            options = splUi.listSpl.map { it.nama },
            selectedOption = barangEvent.namaSupplier,
            onOptionSelected = {
                    selectedSpl -> onValueChange(barangEvent.copy(namaSupplier = selectedSpl))
            },
